...
export class DishEditComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dishService.getDish(dishId).subscribe(dish=>this.dish=dish);
  }

  saveDish(){

    this.dishService.updateDish(this.dish).subscribe(()=>this.back());
  ...
  Delete(){
    this.dishService.deleteDish(this.dish.id).subscribe(()=>this.back());
  }
